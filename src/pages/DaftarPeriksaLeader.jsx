                ...
                <thead>
                  ...
                  <th className="col-3">
                    <div className="mb-4">
                      ...
                      <p className="px-2 fw-normal text-serif text-alat border-bottom mb-1">Lokasi: </p>
                      <p className="px-2 fw-normal text-serif text-alat border-bottom mb-1">Halaman: </p>
                    </div>
                  </th>
                </thead>
              </table>
