            ...
            <div className="row align-items-center">
              ...
              <Table responsive bordered className="table">
                <thead>
                  ...
                  <th className="col-6">
                    <h4 className="header-report-logbook mb-4 fw-semibold">
              ...
              <Table responsive bordered className="table table-bordered">
                <thead className="text-center">
                  <tr>
                    ...
                    <th width="70%" scope="col" className="text-table-logbook align-middle">
                      CATATAN
                    </th>
                  </tr>
                </thead>
                <tbody className="text-center">
                  <td align="justify" className="px-1 text-sm text-table-logbook fw-normal border border-1 align-middle">
